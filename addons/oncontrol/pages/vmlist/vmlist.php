...
if(!$page) {
    ...
    foreach ($userON as $key => $us){
        if($us['host'] == NULL){
            $userON[$key]['host'] = 'NULL';
        }
    }
...
?>
<!--    <script src="https://my.support.by/assets/js/jquery.min.js"></script>-->

    <link rel="stylesheet" href="/assets/css/selectize.css">
    <script src="/assets/js/selectize.js"></script>
    <script src="/modules/addons/oncontrol/js/jquery-ui.min.js"></script>
    <script src="/modules/addons/oncontrol/js/jquery.growl.js"></script>
    <script src="/modules/addons/oncontrol/js/bootstrap_switch.js"></script>
