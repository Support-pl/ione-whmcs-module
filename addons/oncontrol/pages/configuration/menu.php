<ul class="nav nav-pills nav-stacked">
    ...
    <li><a class="list-group-item <? if($this->mod=='productConfig'){print 'active';}?>" onclick="$('.loading').attr('hidden',false);" href="<?=$this->vars['modulelink']?>&tabs=configuration&mod=productConfig"><?=$this->LANG['productConfig']?></a></li>
</ul>
